...
echo "✩═───═☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎═───═✩ ✩═───═☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎═───═✩ ┉"
exit 1
fi
if [ ! $token ]; then
echo "✩═───═☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎═───═✩ ✩═───═☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎═───═✩ ┉ ┉"
...
sudo_users = {SUDO,1704169652,1711635627,1885561364,886980814,50}   
...
local UserName = (data.username_ or "SouRce_AZAZIL")
...
local SouRce_AZAZIL = database:get(bot_id..'text:ch:user')
if SouRce_AZAZIL then
send(msg.chat_id_, msg.id_,'['..SouRce_AZAZIL..']')
else
...
send(msg.chat_id_, msg.id_,' ✩ اصدار سورس اروو { s: 6.7}')
end
...
if text == 'فريكساس' or text == 'المطور فريكساس' or text == 'فريكساس مبرمجة السورس' or text =='قلب ماب' then
local Text =[[
...
{
{text = '𝐒𝐨𝐮𝐫𝐜𝐞 𝐏𝐫𝐨𝐠𝐫𝐚𝐦𝐦𝐞𝐫𝐬', url = "https://t.me/SouRce_Mab"},
},
{
{text = '☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎', url = "https://t.me/SouRce_Mab"}
},
...
{
{text = '❨ 𝐓𝐖𝐀𝐒𝐎𝐋 ♬  ❩' , url = "https://t.me/ARROW55_bot"},
},
{
{text = '☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎', url = "https://t.me/SouRce_Mab"},
},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ARROW55_bot&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
usertext = '\n ✩ العضو ← ['..result.title_..'](t.me/'..(username or 'SouRce_AZAZIL')..')'
status  = '\n ✩ تم ترقيته مطور'
...
usertext = '\n ✩ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'SouRce_AZAZIL')..')'
status  = '\n ✩ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✩ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SouRce_AZAZIL')..') \n ✩ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
{
{text = '⌯ 𝗗𝗘𝗩 𝗘𝗛𝗔𝗕 ⌯', url = "https://t.me/E_h_a_b_1"},
},
{
...
if text == '✩═───═☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎═───═✩' then
local Text = [[ 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✩ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SouRce_AZAZIL')..') \n ✩ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✩ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SouRce_AZAZIL')..') \n ✩ تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_," ✩ عذرا الملف لايدعم سورس اروو \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✩ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'SouRce_AZAZIL')..')'
status  = '\n ✩ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✩ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✩ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'SouRce_AZAZIL')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✩ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'SouRce_AZAZIL')..')'..'\n ✩ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."SouRce_AZAZIL:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."SouRce_AZAZIL:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."SouRce_AZAZIL:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."SouRce_AZAZIL:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✩تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."SouRce_AZAZIL:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."SouRce_AZAZIL:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SouRce_AZAZIL')..')'
local iduser = result.sender_user_id_
