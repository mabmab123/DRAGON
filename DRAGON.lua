...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ↓ :\na✩☦︎═───═☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎═───═✩☦︎\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m✩☦︎═───═☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎═───═✩☦︎\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na✩☦︎═───═☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎═───═✩☦︎\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m✩☦︎═───═☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎═───═✩☦︎\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "✩☦︎═───═☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎═───═✩☦︎ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "✩☦︎═───═☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎═───═✩☦︎ ✩☦︎═───═☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎═───═✩☦︎ ┉"
exit 1
fi
if [ ! $token ]; then
echo "✩☦︎═───═☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎═───═✩☦︎ ✩☦︎═───═☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎═───═✩☦︎ ┉ ┉"
...
send(msg.chat_id_, msg.id_," ✩☦︎ تمت الاذاعه الى *~ "..#list.." ~* جروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' ✩☦︎ اصدار سورس اروو { s: 6.7}')
end
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'✩☦︎ لا يوجد جروبات وهميه في البوت\n')   
else
local DRAGON = (w + q)
...
DRAGON = '\n✩☦︎ تم ازالة ← { '..q..' } جروبات من البوت'
end
if w == 0 then
DRAGONk = ''
else
DRAGONk = '\n✩☦︎ تم ازالة ← {'..w..'} جروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'✩☦︎  عدد الجروبات الان ← { '..#group..' }'..DRAGONk..''..DRAGON..'\n✩☦︎  الان عدد الجروبات الحقيقي ← { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ✩☦︎ العضو ← ['..result.title_..'](t.me/'..(username or 'ABCDABCDL')..')'
status  = '\n ✩☦︎ تم ترقيته مطور'
...
usertext = '\n ✩☦︎ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'ABCDABCDL')..')'
status  = '\n ✩☦︎ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✩☦︎ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ABCDABCDL')..') \n ✩☦︎ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_," ✩☦︎ تمت الاذاعه الى >>{"..#list.."} جروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," ✩☦︎ تمت الاذاعه الى >>{"..#list.."} جروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_,' ✩☦︎ عذا لا يمكنك وضع معرف جروب بالاشتراك ')
return false  end
...
send(msg.chat_id_,0," ✩☦︎ العضو : {["..data.first_name_.."](t.me/SouRce_Mab)}\n ✩☦︎ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✩☦︎ عذرا ← {["..data.first_name_.."](t.me/SouRce_Mab)}\n ✩☦︎ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == '✩☦︎═───═☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎═───═✩☦︎' then
local Text = [[ 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✩☦︎ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ABCDABCDL')..') \n ✩☦︎ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✩☦︎ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ABCDABCDL')..') \n ✩☦︎ تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " ✩☦︎ بس ده بابا عيب")
return false 
end
...
send(msg.chat_id_, msg.id_, " ✩☦︎ لا تسطيع حظر مالك السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1885561364) then  
send(msg.chat_id_, msg.id_, " ✩☦︎ لا تسطيع حظر مطور السورس عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1711635627) then  
send(msg.chat_id_, msg.id_, " ✩☦︎ لا تسطيع كتم مالك السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1885561364) then  
send(msg.chat_id_, msg.id_, " ✩☦︎ لا تسطيع كتم مطور السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(30) then  
send(msg.chat_id_, msg.id_, " ✩☦︎ لا تسطيع كتم مطور السورس عام")
...
if Get_info then
local TextS = "\n ✩☦︎ اهلا بك في متجر ملفات اروو\n ✩☦︎ ملفات السورس ↓\n≪◤━───━??𝗼𝗼𝗼𝗻━───━◥≫\n\n"
local TextE = "\n✩☦︎═───═☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎═───═✩☦︎\n ✩☦︎ علامة تعني { ✔️ } ملف مفعل\n ✩☦︎ علامة تعني { ✖ } ملف معطل\n ✩☦︎ قناة سورس اروو ↓\n".." ✩☦︎ [اضغط هنا لدخول](t.me/SouRce_Mab) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ✩☦︎ عذرا الملف لايدعم سورس اروو \n") 
end
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","✩☦︎ تم تنزيله من مطور")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","✩☦︎ تم تنزيله من المطور")  
else
send(msg.chat_id_, msg.id_,"✩☦︎ لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","✩☦︎ تم تنزيله من مطور ثانوي")  
return false 
end
if text == ("الثانويين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✩☦︎ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'ABCDABCDL')..')'
status  = '\n ✩☦︎ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✩☦︎ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✩☦︎ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'ABCDABCDL')..')'
...
GetWelcome = ' ✩☦︎ لم يتم تعيين ترحيب للجروب'
end 
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✩☦︎ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'ABCDABCDL')..')'..'\n ✩☦︎ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'✩☦︎نت حقير معندكش لقب 😹 ') 
else
...
send(msg.chat_id_, msg.id_, t..'━━━━━━\nاضغط علي الاسم ليتم نسخه\n✩☦︎═───═☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎═───═✩☦︎\n ✩☦︎[ ☾︎♫︎ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗥𝗢𝗪 ♫︎☽︎ ](t.me/SouRce_Mab)✩☦︎ ')
end
